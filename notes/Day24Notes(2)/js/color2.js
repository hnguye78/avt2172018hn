...
function cartoonGuess() {
	...
	var cartoon = Math.floor(Math.random() * imageArray.length);
	var answerlower = cartoonArray[index].toLowerCase();
	var answerlower = cartoonArray[index].toUpperCase();
	var answer = cartoonArray[index];
	console.log(answer);	
